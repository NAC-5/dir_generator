...
def create_subdirectories(root_name, subdirectories):
    ...
    for subdirectory in subdirectories:
        # Builds the full path without manual concatentation.
        # (i.e. root_name + "/" + subdirectory)
...
def main():
    ...
    # Steps: collapse double space -> remove space after comma ->
    # -> remove remaining spaces -> split into list
